...
unsigned short int rest(unsigned short int A,unsigned short int B)
{

   unsigned short int  mantisaA, mantisaB, ordenA, ordenB, Y, mantisa;
   int X;
...
int main(int argc, char *argv[])
{
	...
	unsigned short int restar=0;
	float A, B;

       cout<<"----------------------------JOSAFAT PIRAQUIVE TRIANA----------------------------";
    cout<<"----------------------------------    260911    --------------------------------"<< endl<< endl;

      cout<<"La funcion que cumple el programa es restar"<< endl;
